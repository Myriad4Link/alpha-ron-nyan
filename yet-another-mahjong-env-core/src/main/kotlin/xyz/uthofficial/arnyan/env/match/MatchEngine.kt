...
internal class MatchEngine(
                ...
                when (action) {
                    ...
                    PassAction -> {
                        ...
                        if (subject != null && canCallInterrupts) {
                            ...
                            val hasInterrupt = allActions.any {
                                it.id in listOf(Action.ID_CHII, Action.ID_PON, Action.ID_RON) &&
    ...
    fun submitAction(
        ...
        val finalStepResult =
            if (!stepResult.isOver && state.lastAction is LastAction.Discard && allInterruptsResolved(state)) {
